...
\begin{itemize}
    ...
    \item \texttt{rotation}: la rotazione nella scena 3D, causata dalla proiezione prospettica della fotocamera
...
%
La comunicazione con un broker \ac{mqtt} deve avvenire utilizzando una connessione sicura, in quanto il contesto dell'applicazione è sviluppato con il protocollo \textit{HTTPS}.
...
%
\subsection{Gestione dei Robot emulati}\label{sub:gestione_dei_robot_emulati} % (fold)
% subsection Gestione dei Robot emulati (end)
%
