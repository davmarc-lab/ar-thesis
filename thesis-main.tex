...
Inoltre la stima delle posizioni viene effettuata utilizzando \textit{POSIT}, un'algoritmo iterativo e approssimato della posizione reale, perciò valutando gli stessi dati iniziali più volte è possibile ottenere risultati differenti. Questo fenomeno principalmente è causato da variazioni, anche minime, di numeri decimali durante le iterazioni dell'algoritmo.
...
\section{Scalabilità del sistema}\label{sec:scalabilita_del_sistema} % (fold)

% section Scalabilità del sistema (end)
